        ...
        runBlocking {
            signalRHub.eventFlow.collectLatest {
                if (it is SignalREvent.Open) {
                    ...
                    val result = signalRHub.connect(RealtimeDataService::class.java).subscribe(arguments)
